...
runCmds(cmds, runMode, "L96D5_sdd_f_s", qos="short", timeInMin=60)

cmds <- NULL
for (randomSeed in randomSeeds) {
  cmds <- c(cmds, sprintf(cmdBase, randomSeed, 6, "2^(3:15)", "1:8"))
}
runCmds(cmds, runMode, "L96D6_sdd_f_s", qos="short", timeInMin=60)

cmds <- NULL
for (randomSeed in randomSeeds) {
  cmds <- c(cmds, sprintf(cmdBase, randomSeed, 7, "2^(3:15)", "1:8"))
}
runCmds(cmds, runMode, "L96D7_sdd_f_s", qos="short", timeInMin=60)

cmds <- NULL
for (randomSeed in randomSeeds) {
  cmds <- c(cmds, sprintf(cmdBase, randomSeed, 8, "2^(3:15)", "1:8"))
}
runCmds(cmds, runMode, "L96D8_sdd_f_s", qos="short", timeInMin=1440, memInGb=10)

cmds <- NULL
for (randomSeed in randomSeeds) {
  cmds <- c(cmds, sprintf(cmdBase, randomSeed, 9, "2^(3:15)", "1:8"))
}
runCmds(cmds, runMode, "L96D9_sdd_f_s", qos="short", timeInMin=1440, memInGb=24)
...
runCmds(cmds, runMode, "L96D7_sdd_f_s", qos="short", timeInMin=60, memInGb=10)
...
runCmds(cmds, runMode, "L96D8_sdd_f_s", qos="short", timeInMin=1440, memInGb=20)
...
runCmds(cmds, runMode, "L96D9_sdd_f_s", qos="short", timeInMin=1440, memInGb=50)
